...
class Image extends Database{
	...
	* @return : bool
	*/
	protected function genFilename($id,$cat_id,$cid,$name){
		$filen = $this->genRandom(5);
		$filen = $cid."-".$name . "-" . $id ."-".$cat_id. "." . $this->getExtention();
		$this->filename = $filen;
	...
	* @return : bool
	*/
	public function uploadImage($id,$cat_id,$cid,$name){
		$this->filename = $this->genFilename($id,$cat_id,$cid,$name);
