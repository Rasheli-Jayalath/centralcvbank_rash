              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th width="14%" > Project Description</th>
                    <th width="16%" > Duties Performed</th>
                    <!-- 			89" > Project Cost</th> -->
                    <th width="9%" > iProject <br />
                    Cost</th>
...
//					$detailTasks  			= $objDb->getField($i, detailTasks);
 ...
 <td><a href="experience.php?id=<?=$cvID?>&edit=<?=$empId?>"><img src="images/edit-icon.png" width="20" height="20" /></a></td>                      
                    ...
                    <td ><?=$eToDate?></td>
                    <td ><?=$employeer?></td>
                    <td ><? echo wordwrap($jobTitle,15,"<br>\n");?></td>
                    <td ><? echo wordwrap($projTitle,25,"<br>\n");?></td>
                    <td ><?=$location?></td>
                    <td ><? echo wordwrap($CountryName,25,"<br>\n");?></td>
                    <td ><?=$client?></td>
                     <td ><? echo substr(wordwrap($projDesc,25,"<br>\n"),0,100)."..."; ?></td>
					  
                     <td ><? echo substr(wordwrap($dutiesPerformed,25,"<br>\n"),0,100)."..."; ?></td>
