                               ...
                               <td class="tablerwdata">
                                <?php 
                                    ...
                                    //	$lastupdate				=	$objDb->getField(0, lastupdate);
                                        ...
                                        ?>
                                            <img style="width: 40px;" class="rounded-circle" src="images/noimage/884442_125.jpg" width="40" height="40" alt="Profile pic" title="Click to view upload page..."/> 
                                        <?php }else {
                                        ?>	
                                        ...
                                        elseif ($pic=="" or $piclen <= '12' ) {
                                          if ($cvflag==1 and $cvadmflag==0 and $cventryflag==0){
                                          ?>
                                          <img style="width: 50px;" class="rounded-circle" src="images/noimage/no-profile-img2.gif"  alt="Profile" title="Click to enter Upload Page..."/> 
