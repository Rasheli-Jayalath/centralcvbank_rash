...
-->
     ...
     <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">*Mobile/Contact #</label>
                    <div class="col-sm-9">
       ...
       <div class="row">
          ...
          <p class="card-description">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Start Experrience<br />
                      (yyyy)</label>
<!--  <div class="col-sm-9">
...
-->
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Area of Expertise<em> (seperated by Commas)</em></label> 
                    <div class="col-sm-9">
				  ...
				  <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Work Experience<br> Countries
                    <em> (seperated by Commas)</em></label> 
                    <div class="col-sm-9">
