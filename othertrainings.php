    ...
    <form name="frmpersonalInfo" id="frmcontact" action=""  method="post" onsubmit="return personalinfo(this);"   enctype="multipart/form-data">
     ...
     <div class="col-lg-12 grid-margin stretch-card">
                   ...
                   <div class="table-responsive">
                    <table class="table ">
                      ...
                      <tbody>
                        <tr>
                          <td height="86">
                            <textarea  name="txtDescription" cols="120" rows="10" style="width:600px"/><?= $txtDescription !="" ? $txtDescription : $db_oDesc ?></textarea>
		 ...
		 <div   align="center">
                ...
                if ( $edit != "" ) {
                  ?>
                <input type="submit" value="Update" name="update" class="btn btn-primary me-3" style="color: white;" onclick="return OtherTraining(this);" />
                <?php
                } else {
                  ?>
                <input type="submit" value="Save" name="save" class="btn btn-primary me-3" style="color: white;" onclick="return OtherTraining(this);" />
                <?
                }
                ?>
                &nbsp;&nbsp;
...
word-break: break-all;
				   ...
				   <tr width="84%" >
                     <td> 	<div >
						<?=$i+1 .". ". wordwrap($oDesc,120,"<br>\n")?> </div>	</td>

					   <td style="border-bottom:1px solid #cccccc" align="center" >&nbsp; <a href="othertrainings.php?id=<?=$cvID?>&edit=<?=$oId?>"><img src="images/edit-icon.png" width="22" height="22" /></a></td>

					   <td style="border-bottom:1px solid #cccccc" width="14%" align="center">&nbsp; <a href="delete-otrg.php?id=<?=$cvID?>&delete=<?=$oId?>" onClick="javascript: confirm('Do you really want to delete this record?');" title="Delete Other Training record"><img src="images/deletebutton.png" alt="Delete" width="20" height="20" /></a>
 	             </tr>
				   <?
					}
				}
