...
//echo $updatedon = date("Y-m-d h:m:s") ;
...
$txtyearswithfirm = $_REQUEST['txtyearswithfirm'];
$txtfirmname      = $_REQUEST['txtfirmname'];
...
if($next !=""){
  header ('Location: mop.php?id='.$cvID);
}

if($save !=""){
  $iSql = "Insert into tblfirm SET 
            cvId         = '$cvID',
			yearWithFirm = '$txtyearswithfirm',
			firmName     = '$txtfirmname',
...
// echo $iSql;
	...
	$tuSql = "update blcvmain SET datetime = now(),  ep_name = '$strusername' where cvId = '$cvID'";
...
//$updatedon = date("F j, Y, g:i a");

if($update !=""){
  $uSql = "Update tblfirm SET 
		yearWithFirm = '$txtyearswithfirm',
		firmName     = '$txtfirmname',
		designation  = '$txtdesignation', 
...
if($edit !=""){
  $eSql = "Select * from tblfirm where fId='$edit'";
  $objDb2 ->query($eSql);
  $eCount = $objDb2->getCount();
	
	if($eCount > 0){
	  $dFId         = $objDb2->getField(0,fId);
	  ...
	  $dFirmName     = $objDb2->getField(0,firmName);
	  $dDesignation  = $objDb2->getField(0,designation);
	  $dDescription  = $objDb2->getField(0,description);
	  $dYearWithFirm = $objDb2->getField(0,yearWithFirm);
...
<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
    <div class="me-3">
      <button class="navbar-toggler navbar-toggler align-self-center" type="button" data-bs-toggle="minimize"> <span class="icon-menu"> </button>
    </div>
    ...
    <button class="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-bs-toggle="offcanvas"> <span class="mdi mdi-menu"> </button>
  </div>
</nav>
  ...
  <div class="tab-content" id="setting-content">
    <div class="tab-pane fasede show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
      ...
      <div class="events pt-4 px-3">
        <div class="wrapper d-flex mb-2"> <i class="ti-control-record text-primary me-2"></i> <span>Feb 11 2018 </div>
        <p class="mb-0 font-weight-thin text-gray">Creating component page build a js</p>
        <p class="text-gray mb-0">The total number of sessions</p>
      </div>
      <div class="events pt-4 px-3">
        <div class="wrapper d-flex mb-2"> <i class="ti-control-record text-primary me-2"></i> <span>Feb 7 2018 </div>
    ...
    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
      ...
      <ul class="chat-list">
        <li class="list active">
          <div class="profile"><img src="images/faces/face1.jpg" alt="image"><span class="online"></div>
          <div class="info">
            <p>Thomas Douglas</p>
            <p>Available</p>
          </div>
        ...
        <li class="list">
          <div class="profile"><img src="images/faces/face2.jpg" alt="image"><span class="offline"></div>
          <div class="info">
        ...
        <li class="list">
          <div class="profile"><img src="images/faces/face3.jpg" alt="image"><span class="online"></div>
          <div class="info">
            <p>Daniel Russell</p>
            <p>Available</p>
          </div>
        ...
        <li class="list">
          <div class="profile"><img src="images/faces/face4.jpg" alt="image"><span class="offline"></div>
          <div class="info">
        ...
        <li class="list">
          <div class="profile"><img src="images/faces/face5.jpg" alt="image"><span class="online"></div>
          <div class="info">
        ...
        <li class="list">
          <div class="profile"><img src="images/faces/face6.jpg" alt="image"><span class="online"></div>
          <div class="info">
            <p>Sarah Graves</p>
            <p>Available</p>
          </div>
...
<div class="main-panel">
          ...
          <div class="tab-content tab-content-basic">
            <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
              ...
              <form name="frmpersonalInfo" id="frmcontact" action=""  method="post" onsubmit="return personalinfo(this);"   enctype="multipart/form-data">
                ...
                <div class="card">
                <div class="card-body">
                <h3 class="card-title">Firm Info Detail </h3>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="txtStartDate" class="form-control" value="<?= $eFromDate !="" ? $eFromDate : $txtStartDate ?>"  maxlength="7"   />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="txtLastDate" class="form-control" value="<?= $eToDate !="" ? $eToDate : $txtLastDate ?>" maxlength="7"   />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control" value="<?= $txtfirmname !="" ? $txtfirmname : $dFirmName ?>" name="txtfirmname"   />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input id="txtdesignation" class="form-control" name="txtdesignation" type="text" value="<?php if($dDesignation!="") {echo $dDesignation ;} else {echo $designation;} ?>"/>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <p class="card-description"> <strong>Summary of Activities performed / Description:</strong><br />
                        [ Ctrl+Shift+V ] for Paste Data here. </p>
                      <div class="col-sm-9">
                        <?php
                        if ($dDescription == "") $dDescription = $txtdescription;
                        else $Description1 = $dDescription;
                      ...
                      <div class="col-sm-9">
                        <select name="txtCountry"  class="form-control">
                          ...
                          for ( $i = 0; $i < $iCount; $i++ ) {
                            ...
                            ?>
                          <option value="<?= $iId1 ?>"<? if($iId1 == $country || $iId1==$txtCountry) echo " selected"; ?>>
                          <?= $sName1 ?>
                          </option>
                          <?
                          }
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                           <input type="text" class="form-control" value="<?= $refName !="" ? $refName : $txtrefName ?>" name="txtrefName"   />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?= $refDesig !="" ? $refDesig : $txtrefDesig ?>" name="txtrefDesig" class="form-control"  />
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" value="<?= $refTele !="" ? $refTele : $txtrefTele ?>" name="txtrefTele" class="form-control" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                       <input type="text" value="<?= $refEmail !="" ? $refEmail : $txtrefEmail ?>" name="txtrefEmail" class="form-control" />
                      </div>
                    </div>
                  </div>
                </div>
 ...
 <div class="col-lg-12 grid-margin stretch-card" >
              <div class="card">
                <div class="card-body">
                  <strong>
                  <h4 class="card-title">Firm  Detail<h4>
                ...
                <tr>
                  <th width="8%">From</th>
                  <th width="8%">To</th>
                  <th width="6%">Employer</th>
                  <th width="15%">Position Held</th>
                  <th width="26%">Summary/ Description</th>
                  <th width="9%">Country</th>
                  <th width="10%">Ref. Name</th>
               
                    <th width="11%" align="center"> Edit  </th>
                    <th width="7%" align="center" > Delete  </th>
                </tr>	
         <?
			$sSQL1 = " Select * from tblfirm where cvId = '$cvID' order by CONCAT(RIGHT(eFromDate,4), LEFT(eFromDate,4)) desc";
			$objDb->query($sSQL1);
			$iCount = $objDb->getCount( );
			if($iCount>0)
			{
				for ($i = 0 ; $i < $iCount; $i ++)
				{
				$fId          = $objDb->getField($i,fId);
				$cvId         = $objDb->getField($i,cvId);
				$yearWithFirm = $objDb->getField($i,yearWithFirm);
				$firmName     = $objDb->getField($i,firmName);
				$designation  = $objDb->getField($i,designation);
				$description  = $objDb->getField($i,description);
			...
			?>
				   <tr>
				     <td  ><?=$eFromDate?></td>
				     <td  ><?=$eToDate?></td>
				     <td  ><? echo wordwrap($firmName,10,"<br>\n");?></td>
				     <td  ><? echo wordwrap($designation,3,"<br>\n");?></td>
				     <td  ><? echo wordwrap($description, 5),"<br>\n"; ?></td>
				     <td  ><? echo wordwrap($CountryName,6,"<br>\n");?></td>
				     <td  ><? echo wordwrap($refName,6,"<br>\n");?></td>
					   
		  <td  width="11%" align="center">
  				<a href="firminfo.php?id=<?=$cvID?>&edit=<?=$fId?>"><img src="images/edit-icon.png" width="22" height="22" /></a></td>

			<td  width="7%" align="center"> <a href="delete-firminfo.php?id=<?=$cvID?>&delete=<?=$fId?>" onClick="javascript: confirm('Do you really want to delete this record?');" title="Delete Firm Info record"><img src="images/deletebutton.png" alt="Delete" width="20" height="20"  /></a>
					   </td>
 			</tr>
				   <?
					}
