              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form name="searchfrm" id="searchfrm" action="latest-cvs.php"  method="post"  >
                    <table  width="80%"  style="border-collapse: separate; border-spacing:0 8px; font-size: 13px;" cellpadding="1" cellspacing="1">
                      <tr>
                        <td  class="label text-end mt-1">&nbsp;</td>
                        <td >&nbsp;</td>
                        <td class="label text-end mt-1">&nbsp;</td>
                        <td align="right" ><input style="margin-top: 15px; color: white;" class="btn btn-primary" width="200px" type="submit" value="GO" name="btn"  onclick="return validateSearch();"  /></td>
                      </tr>
                      <tr>
 ...
 -->
                      ...
                      <tr>
                        ...
                        <td ><select class="form-select form-select-sm" name="cvVerification" >
						  ...
						  <tr>
                        <td height="26" class="label text-end mt-2" ><span class="label text-end mt-1">Edu. Institute:</span></td>
					  ...
					  <tr>
                        ...
                        <td></td>
                        <td colspan="3">
							<input style="margin-top: 15px; color: white;" class="btn btn-primary" width="200px" type="submit" value="GO" name="btn"  onclick="return validateSearch();"  /></td>
                      </tr>
						 <tr>
                            <td height="26" class="label text-end mt-2" ><!--  <strong>Duties Performed:</strong> --></td>
                            <td > <!--  <input class="form-control" type="text" value="" name="dutiesPerformed"  />  --></td>
                            <td  class="label text-end mt-1">&nbsp;</td>
                            <td colspan="3">&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="26" class="label text-end mt-2" >&nbsp;</td>
                        <td >&nbsp;</td>
