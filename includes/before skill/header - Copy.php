...
$pages = array('submit-cv.php','firminfo.php','mop.php','education.php','language.php','othertrainings.php','cvlist.php','achievements.php','experience.php','dta.php','uploadcv.php', 'statistics.php');
?>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div style="color:#E9E9E9; font-size:48px; float:right; font-weight:bold; width:300px; margin-top:15px" >CV Bank</div>--> 
 ...
 <div id="topmenu">
	...
	<?
	if($sCurPage!='search.php' && $sCurPage!='cvlist.php' && $sCurPage!='index.php' && $sCurPage!='searchadv.php'&& $sCurPage!='statistics.php')
	{
	?>
	<ul id="cv-menu">
