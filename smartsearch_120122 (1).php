...
<tr>
  <td   colspan="3" align="center"><h3><strong>SMART Search</strong></h3></td> 
	...
	<tr>
	  ...
	  <input name="valued" class="form-control" type="text" onKeyUp="showResult(valueac.value, valuea.value, valueb.value, valuec.value,this.value, valuee.value, valuef.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="10" maxlength="50"></td>
...
<tr>
  <td align="right" class="labelup"><label>Experience (yr): </label></td>
	<td ><input name="valuec" class="form-control" type="text" onKeyUp="showResult(valueac.value, valuea.value,valueb.value,this.value,valued.value,valuee.value,valuef.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="10" maxlength="20"></td>
...
<tr>
  <td align="right" class="labelup"><label>Position: </label></td>
	<td ><input name="valuef" class="form-control" type="text" onKeyUp="showResult(valueac.value, valuea.value, valueb.value, valuec.value, valued.value, valuee.value,this.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="10" maxlength="30"></td>
...
<tr>
  <td align="right" class="labelup"><label>Key Qualification: </label></td>
	<td ><input name="valuee" class="form-control" type="text" onKeyUp="showResult(valueac.value, valuea.value, valueb.value, valuec.value, valued.value, this.value,valuef.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="10" maxlength="30"></td>
  <td class="labelcomment"><em> any text from key qualification.</em></td>
</tr>

<tr>
  <td align="right" class="labelup"><label>Qualification: </label></td>
	<td class="labelcomment"><input name="valueb" class="form-control" type="text" onKeyUp="showResult(valueac.value, valuea.value, this.value, valuec.value, valued.value, valuee.value,valuef.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="10" maxlength="30"></td>
...
<td class="labelcomment"><input name="valuea" class="form-control" type="text" onKeyUp="showResult(valueac.value, this.value, valueb.value, valuec.value,valued.value,valuee.value,valuef.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="20" maxlength="10"></td>
...
<tr>
		...
		<td class="labelcomment" >
			<select name="valueac"  onchange="showResult(this.value, valuea.value,valueb.value,valuec.value,valued.value,valuee.value,valuef.value, valueid.value, valueo.value,valuesa.value,valueos.value)" size="1" maxlength="50">
...
<tr  >
  <td align="right" class="labelup">
	...
	<td ><input name="valueid" type="text" onKeyUp="showResult(valueac.value, valuea.value, valueb.value, valuec.value, valued.value,valuee.value,valuef.value, this.value, valueo.value,valuesa.value,valueos.value)" size="25" maxlength="255"></td>
...
<td  >
<select name="valueo" onchange="showResult(valueac.value, valuea.value, valueb.value, valuec.value, valued.value,valuee.value,valuef.value,valueid.value,this.value,valuesa.value, valueos.value)">
<option value="cvId">ID</option>
<option value="name">Name</option>
<option value="position">Position</option>
<option value="startexpyr">Experience</option>
</select>
<select name="valueos" onchange="showResult(valueac.value, valuea.value, valueb.value, valuec.value, valued.value,valuee.value,valuef.value,valueid.value,valueo.value,valuesa.value, this.value)">
...
<tr bgcolor="#f1f1f1">
  <td   align="right"  class="labelup"> Selection: </td>
	<td >
  <select name="valuesa" onchange="showResult(valueac.value, valuea.value, valueb.value, valuec.value, valued.value,valuee.value,valuef.value,valueid.value,valueo.value,this.value, valueos.value)">
...
<? include ("includes/footer.php"); ?>
  ...
  <script>
      function showResult(strac, stra, strb, strc, strd, stre, strf, strid, stro, strsa, stros) {
       ...
       // xmlhttp.open("GET","livesearch_revamped.php?a="+stra+"&b="+strb+"&c="+strc+"&d="+strd+"&e="+stre+"&f="+strf+"&id="+strid+"&o="+stro+"&sa="+strsa+"&os="+stros,true);
		xmlhttp.open("GET","livesearch_revamped.php?ac="+strac+"&a="+stra+"&b="+strb+"&c="+strc+"&d="+strd+"&e="+stre+"&f="+strf+"&id="+strid+"&o="+stro+"&sa="+strsa+"&os="+stros,true);
		xmlhttp.send();
      }
</script>
