...
//echo $sSQL;
    ...
    $txtid = $objDb->getAutoNumber();
 	$cvId = $txtid;
	$txtname=mysql_real_escape_string(trim($txtname));
...
if($cvID!="")
{
	...
	$ocv="images/originbiralcv/".$dboriginalcv;}
}
        ...
        <div class="tab-content tab-content-basic">
          <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
            ...
            <form name="frmpersonalInfo" id="frmcontact" action=""  method="post" onsubmit="return personalinfo(this);"   enctype="multipart/form-data">
              ...
              <div class="card">
              <div class="card-body">
              <h3 class="card-title"><h3>Personal Info: ID #:</h3> 
           <br />
<br />
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Enter the Name" name="txtname" id="txtname"  value="<?php if($name!="") echo $name; else echo $txtname; ?>" style="width: 100%" />
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                  <input type="text" class="form-control" placeholder="Father's name" name="txtfatherName" id="txtfatherName"  value="<?php if($fatherName!="") echo $fatherName; else echo $txtfatherName; ?>" style="width: 100%" />
                  </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" value="M" name="chkgender" id="chkgender" <?php if($gender=='M' || $chkgender=='M') echo 'checked="checked"'; else  echo ''; ?> />Male</label>
                      </div>
                    </div>
                    <div class="col-sm-5">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" value="F" name="chkgender" id="chkgender" <?php if($gender=='F' || $chkgender=='F') echo 'checked="checked"'; else   echo ''; ?> />Female </label>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if ($dob=='01-01-1970' || $dob=='1970-01-01' || $dob=='01-01-1900' || $dob=='1900-01-01') { echo '';} else {echo $dob;};?>" name="txtdob"  placeholder="dd/mm/yyyy" style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Place  Birth/<br>Location</label>
                    <div class="col-sm-9">
                      <input type="text" value="<?php if($location!="") echo $location ; else echo $txtlocation; ?>" name="txtlocation" class="form-control" style="width: 100%"  />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control"  value="<?php if($email!="") echo $email ; else echo $txtemail; ?>" name="txtemail" title="Email for Sending or acknowledgement purposes..." style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Birth/ Country <br>of Origin</label>
                    <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($emailTwo!="") echo $emailTwo ; else echo $txtemailTwo; ?>" name="txtemailTwo"  style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control"  value="<?php if($cnic!="") echo $cnic ; else echo $txtcnic; ?>" name="txtcnic"  style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
     ...
     <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($passportNo!="") echo $passportNo ;else echo $txtpassport; ?>" name="txtpassport" style="width: 100%"  />
                    </div>
                  </div>
                </div>
     ...
     <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($mobile!="") echo $mobile ; else echo $txtmobile; ?>" name="txtmobile"  style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
       ...
       <div class="row">
          ...
          <p class="card-description">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
					<input type="text" name="txtpaddress" class="form-control" value="<?php if($permanentAddress!="") {echo $permanentAddress ;} else {echo $txtpaddress; } ?>" style="height: 80px; width: 100%" />
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="txtcorrespondenceAddress" class="form-control" value=" <?php if($correspondenceAddress!="") echo $correspondenceAddress ; else echo $txtcaddress; ?>" style="height: 80px; width: 100%"/>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="txtcompcap"  class="form-control" value="<?php if($computerCapabilities!="") echo $computerCapabilities ; else echo $txtcompcap; ?>" style="height: 80px; width: 100%"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($profession!="") echo $profession ; else echo $txtprofession; ?>" name="txtprofession"  style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($position!="") echo $position ; else echo $txtposition; ?>" name="txtposition"  style="width: 100%" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Start Experrience<br> (yyyy)</label>
                    <div class="col-sm-9">
                      <input name="txtstartexpyr" type="text" class="form-control" value="<?php if($startexpyr!="") echo $startexpyr ; else echo $txtstartexpyr; ?>" size="4" maxlength="4"  minlength="4"  style="width: 100%" />
                     <span style="font-size: 12px"> <strong><em><?php echo $texpyr = ($nowyear - $startexpyr);?> Yrs</em></strong> </span></div>
                  </div>
                </div></div>
<!--                <div class="col-md-6">
                  <div class="form-group row">
...
-->
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Area of<br> Expertise</label>
                    <div class="col-sm-9">
                      <input type="text" name="txtareaofexpertise" id="txtareaofexpertise" class="form-control" style="height:50px; width: 100%;" value="<?php if($areaOfExp!="") {echo $areaOfExp ;} else {echo  $txtareaofexpertise; } ?>"  />
                    </div>
                  </div>
                </div>
				  ...
				  <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Work Experience<br> Countries:</label>
                    <div class="col-sm-9">
                      <input type="text" name="txtwecountries" id="txtwecountries" class="form-control" style="height:50px; width: 100%;" value="<?php if($workExpCountries!="") echo $workExpCountries ; else echo $txtwecountries; ?>" />
                    </div>
                  </div>
                </div>
               </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label"><strong>Key Qualification</strong></label>
                  <div class="col-sm-12">
                    <?php
              ...
              <div class="row">
                <div class="col-md-6">
                  <br />
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="txtremarks" value="<?php if($remarks!="") echo $remarks ; else echo $txtremarks; ?>"  style="width: 100%" />
                    </div>
                  </div>
                </div>
			...
			<p class="card-description">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($addInfo1!="") echo $addInfo1 ;else echo $txtinfo1; ?>" name="txtinfo1"  style="width: 100%" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($addInfo2!="") echo $addInfo2 ;else echo $txtinfo2; ?>" name="txtinfo2"  style="width: 100%" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="txtinfodetail" value="<?php if($addInfoDetail!="") echo $addInfoDetail ; else echo $txtinfodetail; ?>"  style="width: 100%"/>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="txtref" value="<?php if($referece !="") echo $referece ; else echo $txtref; ?>" style="width: 100%" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Acknow. Email<br> Sent</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php if($addInfo3!="") echo $addInfo3 ;else echo $txtinfo3; ?>" name="txtinfo3"   style="width: 100%"  />
                  </div>
                </div>
              </div>
         ...
         <div class="row">
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php if($linkedin_link !="") echo $linkedin_link ; else echo $txtlinkedin_link; ?>" name="txtlinkedin_link" style="width: 100%"      />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Other Social <br>Links:</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php if($osocial_media !="") echo $osocial_media ; else echo $txtosocial_media; ?>" name="txtosocial_media"  style="width: 100%"    />
                  </div>
                </div>
              </div>                  
  ...
  <div class="col-md-7">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Level/Salary Range </label>
                  <div class="col-sm-4">
                    <div class="form-check">
                      <label class="form-check-label">
 ...
 <div class="row">
              <div class="col-md-6">
                <div class="form-group row"><strong>Current Experience <br />
                with  Firm (Yrs):</strong>
                  <div class="col-sm-9">
                    <input type="text" class="form-control"  value="<?php if($exp_current!="") echo $exp_current ;else echo $txtexp_current; ?>" name="txtexp_current" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group row"><strong>Previous  Experience <br />
                with Firm (Yrs):</strong>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" value="<?php if($exp_prev!="") echo $exp_prev; else echo $txtexp_prev; ?>" name="txtexp_prev"/>
                  </div>
                </div>
              </div>                  
              ...
              <div class="col-sm-6">
                <div class="form-check form-check-flat form-check-primary">
                    <label class="form-check-label">
                    <h3>BD Profile Intimation</h3> <input type="checkbox" value="1" name="chkbdprofile" <?php if($bdprofile=='1' || $chkbdprofile=='1') echo 'checked="checked"';  ?> /></label>
                </div>
              </div></div>
