          ...
          <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
            ...
            <form name="frmpersonalInfo" id="frmcontact" action=""  method="post" onsubmit="return personalinfo(this);"   enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Name" name="txtname" id="txtname"  value="<?php if($name!="") echo $name; else echo $txtname; ?>" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" value="M" name="chkgenderRadios" id="chkgender" <?php if($gender=='M' || $chkgender=='M') echo 'checked="checked"'; else  echo ''; ?> />
                          Male</label>
                      </div>
                    </div>
                    <div class="col-sm-5">
                      <div class="form-check">
                        <label class="form-check-label">
                          <input type="radio" class="form-check-input" value="F" name="chkgenderRadios" id="chkgender" <?php if($gender=='F' || $chkgender=='F') echo 'checked="checked"'; else   echo ''; ?> />
                          Female </label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <select name="cmbmstatus" style="width:100px;" class="form-control">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($landline!="") echo $landline ; else echo $txtlandline; ?>" name="txtlandline" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">NTN/SSN #:</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control"  value="<?php if($ssn!="") echo $ssn ; else echo $txtssn; ?>" name="txtssn"  />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="<?php if($location!="") echo $location ; else echo $txtlocation; ?>" name="txtlocation"  />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="<?php if($profession!="") echo $profession ; else echo $txtprofession; ?>" name="txtprofession" class="form-control" />
                  </div>
                </div>
            </div>
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Proposed Position</label>
                    <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Start Exper.(yyyy)</label>
                    <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input  type="text" name="txtareaofexpertise" id="txtareaofexpertise" class="form-control" value="<?php if($areaOfExp!="") {echo $areaOfExp ;} else {echo  $txtareaofexpertise; } ?>"  />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">                   <style> span {float:left;}</style>

                      <input type="text" class="form-control" name="txtwecountries" value="<?php if($workExpCountries!="") {echo $workExpCountries ;} else {echo "<span>".$txtwecountries."</span>";} ?>" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="txtremarks" value="<?php if($remarks!="") echo $remarks ; else echo $txtremarks; ?>" style="height: 140px"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Country???tempvar</label>
                  <div class="col-sm-9">
              ...
              <div class="row" >
                ...
                <div class="form-check form-check-flat form-check-primary"  >
                  <label class="form-check-label">
                    BD Profile Intimation <input type="checkbox" value="1" name="chkbdprofile" <?php if($bdprofile=='1' || $chkbdprofile=='1') echo 'checked="checked"';  ?> /></label>
                </div>
              </div></div>
             ...
             <div   align="center">
              ...
              if ( $cvID != "" ) {
              ?>
              <input type="submit" value="Update" name="update" class="btn btn-primary mb-3" style="width:200px"/>
              &nbsp;&nbsp;
              <input type="submit" value="Next" name="next" class="btn btn-primary me-3" style="width:200px" />
              <?php
              } else {
                ?>
              <input type="submit" value="Save & Next" name="save" id="save" class="btn btn-primary me-3" style="width:200px"/>
              <?php
              }
              ?>
              &nbsp;&nbsp;
              <input type="submit" value="Clear" name="clear"  class="btn btn-light" style="width:200px"/>
           <br /><br />
