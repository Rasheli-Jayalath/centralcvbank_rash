                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between" style="text-align: center;">
                          ...
                          <div style="display: flex; justify-content: center;align-items: center; height: 250px;width: 210px; background-image: linear-gradient(to bottom right, #00b09b, #96c93d); padding: 30px;border-radius: 20px;">
                            <div> <img src="images/faviconblue.png" height="50px"/>
                              <p style="font-size: 20px; margin-top: 30px;color: white;font-weight: 500;">Pakistan </p>
                              <h1  style="font-weight: 900;color: white">1938</h1>
                            </div>
                          </div>
                          <div style="display: flex; justify-content: center;align-items: center;height: 250px;width: 210px; background-image: linear-gradient(to bottom right, #FF5F6D, #FFC371); padding: 30px;border-radius: 20px;">
                            <div> <img src="images/faviconblue.png" height="50px"/>
                              ...
                              <h1  style="font-weight: 900;color: white">1080</h1>
                            </div>
                          </div>
                          <div style="display: flex; justify-content: center;align-items: center; height: 250px;width: 210px; background-image: linear-gradient(to bottom right, #ff6e7f,#bfe9ff); padding: 30px;border-radius: 20px;">
                            <div> <img src="images/faviconblue.png" height="50px"/>
                              <p style="font-size: 20px; margin-top: 30px;color: white;font-weight: 500;">Nepal </p>
                              <h1  style="font-weight: 900;color: white">222</h1>
                            </div>
                          </div>
                          <div style="display: flex; justify-content: center;align-items: center; height: 250px;width: 210px; background-image: linear-gradient(to bottom right, #757F9A,#D7DDE8); border-radius: 20px;">
                            <div> <img src="images/faviconblue.png" height="50px"/>
                              <p style="font-size: 20px; margin-top: 30px;color: white;font-weight: 500;">Georgia</p>
                              <h1  style="font-weight: 900;color: white">212</h1>
                            </div>
                          </div>
                          <div style="display: flex; justify-content: center;align-items: center; height: 250px;width: 210px; background-image: linear-gradient(to bottom right, #F8CDDA, #1D2B64 ); padding: 30px;border-radius: 20px;">
                          ...
                          <p style="font-size: 20px; margin-top: 30px;color: white;font-weight: 500;">Bangladesh </p>
                              <h1  style="font-weight: 900;color: white">2102</h1>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-8 d-flex flex-column">
                        <div class="row flex-grow">
                          <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <h4 class="card-title">Country wise CVs</h4>
