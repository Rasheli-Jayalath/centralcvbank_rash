...
<div class="content-wrapper">
  <div class="row">
    <div class="col-sm-12">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="statistics-details d-flex align-items-center justify-content-between" style="text-align: center;">
              <div style="display: flex; justify-content: center;align-items: center; height: 200px;width: 200px; background-image: linear-gradient(to bottom right, #7F7FD5, #91EAE4); padding: 30px;border-radius: 20px;">
                <div> <img src="images/phdpic.png" height="90px"/>
                  <p style="font-size: 20px; margin-top: 5px;color: white;font-weight: 500;">Doctorate</p>

 				 <?
                  $sSQL02 = " SELECT ediscipline, count(ediscipline) as totalrec FROM tbleducation where eDiscipline='Doctorate' ";
                  $objDb->query( $sSQL02 );
                  
                   $totalrec = $objDb->getField( 0, totalrec );
 				?>					
					
				  <h1  style="font-weight: 700;color: white"><?=$totalrec  ?></h1>
                </div>
            </div>
              <div style="display: flex; justify-content: center;align-items: center; height: 200px;width: 200px; background-image: linear-gradient(to bottom right, #00b09b, #96c93d); padding: 30px;border-radius: 20px;">
                <div> <img src="images/mastersimg.png" height="80"/>
                  <p style="font-size: 20px; margin-top: 5px;color: white;font-weight: 500;">M.Phil/MS </p>
						<?
						$sSQL02 = " SELECT ediscipline, count(ediscipline) as totalrec FROM tbleducation where eDiscipline='M.Phil/MS' ";
						$objDb->query( $sSQL02 );

						$totalrec = $objDb->getField( 0, totalrec );
						?>					
					
				  <h1  style="font-weight: 700;color: white"><?= $totalrec  ?></h1>                </div>
              </div>
              <div style="display: flex; justify-content: center;align-items: center;height: 200px;width: 200px; background-image: linear-gradient(to bottom right, #FF5F6D, #FFC371); padding: 30px;border-radius: 20px;">
                <div> <img src="images/gradd.png" height="60"/>
                  <p style="font-size: 20px; margin-top: 5px;color: white;font-weight: 500;">Masters</p>
                 
				<?
						//$sSQL02 = " SELECT ediscipline, count(ediscipline) as totalrec FROM tbleducation where eDiscipline='Masters' group by eDiscipline ";
					  	$sSQL02 = " SELECT COUNT(*) as totalrec FROM (SELECT eDiscipline FROM tbleducation where eDiscipline='Masters' GROUP by cvid) AS tbl";
						$objDb->query( $sSQL02 );
              ...
              <div style="display: flex; justify-content: center;align-items: center; height: 200px;width: 200px; background-image: linear-gradient(to bottom right, #ff6e7f,#bfe9ff); padding: 30px;border-radius: 20px;">
                <div> <img src="images/ssss.png" height="80"/>
                  <p style="font-size: 20px; margin-top: 5px;color: white;font-weight: 500;">Graduation</p>
						<?
					  	$sSQL02 = " SELECT COUNT(*) as totalrec FROM (SELECT eDiscipline FROM tbleducation where eDiscipline='Graduation' GROUP by cvid) AS tbl";
						$objDb->query( $sSQL02 );
     ...
     <!--         <div style="display: flex; justify-content: center;align-items: center; height: 250px;width: 210px; background-image: linear-gradient(to bottom right, #757F9A,#D7DDE8); border-radius: 20px;">
                <div> <img src="images/faviconblue.png" height="50px"/>
                  <p style="font-size: 20px; margin-top: 5px;color: white;font-weight: 500;">Georgia</p>
                  <h1  style="font-weight: 700;color: white">212</h1>
                </div>
              </div>
-->

<!--              <div style="display: flex; justify-content: center;align-items: center; height: 200px;width: 200px; background-image: linear-gradient(to bottom right, #F8CDDA, #1D2B64 ); padding: 30px;border-radius: 20px;">
                <div> <img src="images/smeclogowhite.png" height="80px"/>
                  <p style="font-size: 20px; margin-top: 5px;color: white;font-weight: 500;">Diploma Holder*</p>
					<?
					  	$sSQL02 = " SELECT COUNT(*) as totalrec FROM (SELECT eDiscipline FROM tbleducation where eDiscipline='Diploma Holder' GROUP by cvid) AS tbl";
						$objDb->query( $sSQL02 );
        ...
        <div class="row"> 
          ...
          <!-- Chart CV Entry Progress -->
          <div class="col-lg-8 d-flex flex-column">
            <div class="row flex-grow">
              <div class="col-12 col-lg-4 col-lg-12 grid-margin stretch-card">
                <div class="card card-rounded">
                  <div class="card-body">
                    <h4 class="card-title">Chart for Country wise CVs</h4>
          ...
          <div class="col-lg-4 d-flex flex-column"> 
            ...
            <div class="row flex-grow">
              <div class="col-12 grid-margin stretch-card">
                <div class="card card-rounded">
                  <div class="card-body">
                    <h4 class="card-title">CV Status</h4>
              ...
              <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                <div class="card card-rounded">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="bg-primary" style="color: white;padding: 10px;border-radius: 15px;text-align: center;"> <i class="mdi mdi-earth" style="font-size: 30px;"></i>
                          <p class="text-small mb-2"  style="font-size: 13px;"> Foreigners</p>
                          <a href="#">
                          <h4 class="mb-0 fw-bold" style="font-size: 25px;color: gold;">411</h4>
                          </a> </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="bg-primary" style="color: white;padding: 10px;border-radius: 15px;text-align: center;"> <i class="mdi mdi-check-all" style="font-size: 30px;"></i>
                          <p class="text-small mb-2" style="font-size: 13px;">Verified CVs</p>
                          <a href="#">
                          <h4 class="mb-0 fw-bold" style="font-size: 30px;color: gold;" >364</h4>
                          </a> </div>
                      </div>
                    </div>
                    <div class="row" style="margin-top: 10px;">
                      <div class="col-sm-6">
                        <div class="bg-primary" style="color: white;padding: 10px;border-radius: 15px;text-align: center;"> <i class="mdi mdi-tie" style="font-size: 30px;"></i>
                          <p class="text-small mb-2" style="font-size: 13px;">Ph.D. Doctors</p>
                          <a href="#">
                          <h4 class="mb-0 fw-bold" style="font-size: 30px;color: gold;">76</h4>
                          </a> </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="bg-primary" style="color: white;padding: 10px;border-radius: 15px;text-align: center;"> <i class="mdi mdi-sync-alert" style="font-size: 30px;"></i>
                          <p class="text-small mb-2" style="font-size: 13px;">Pending CVs</p>
                          <a href="#">
                          <h4 class="mb-0 fw-bold" style="font-size: 30px;color: gold;">108</h4>
                          </a> </div>
                      </div>
                    </div>
                  </div>
      ...
      <div class="row flex-grow">
        <div class="col-md-6 col-lg-6 grid-margin stretch-card">
          <div class="card card-rounded">
            <div class="card-body card-rounded">
              <h4 class="card-title  card-title-dash">Natioanltiy-wise CVs </h4>
              <div class="wrapper w-100">
                <div class="list align-items-center">
                  <?
                  $sSQL1 = "SELECT nationality, count(nationality) as total FROM tblcvmain where startexpyr > 1983  and nationality<>104 group by nationality ORDER BY total DESC";
                  //echo $sSQL1;
                  $objDb->query( $sSQL1 );
                  $iCount = $objDb->getCount();
                  for ( $i = 0; $i < $iCount; $i++ ) {
                      $nationality = $objDb->getField( $i, nationality );
                      $sqln = "select name, flag from tblcountries where countryId=$nationality";
                      $queryn = mysql_query( $sqln );
                      if ( mysql_num_rows( $queryn ) > 0 ) {
                          $res = mysql_fetch_array( $queryn );
                          $country_name = $res[ 'name' ];
                          $flag = $res[ 'flag' ];
                          $total = $objDb->getField( $i, total );
                          ?>
                
                    <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                      <div class="d-flex"> <img src="images/countries/<?php echo $flag;?>" style="width:30px"  />
                        <div class="wrapper ms-3">
                          <p class="ms-1 mb-1 fw-bold"><?php echo $country_name;?></p>
                          <small class="text-muted mb-0">
                          <?php //echo $total;?>
                          </small> </div>
                      </div>
                      <div class="text-muted text-small"> <?php echo $total;?></div>
                    </div>
                    <?php }	}	?>
                       </div>
                          </div>
   ...
   <div class="card card-rounded">
            <div class="card-body card-rounded">
              <h4 class="card-title  card-title-dash">Sector - Wise CVs</h4>
              <div class="wrapper w-100">
 					
				<div class="wrapper d-flex align-items-center justify-content-between ">
                  <?
//					  $sSQL1 = "SELECT fgroup, count(fgroup) as total1 FROM tblcvmain where startexpyr > 1981  group by fgroup ORDER BY total1 DESC";
					  $sSQL1 = "SELECT fgroup, count(fgroup) as total1 FROM tblcvmain  group by fgroup ORDER BY fgroup asc";
					...
					//echo $sSQL1;
					  ...
					  for ( $i = 0; $i < $iCount; $i++ ) {
						  ...
						  $total1 = $objDb->getField( $i, total1 );
                   ?>
         <p class="mb-2 font-weight-medium"> 
			<small class="text-muted mb-0">
				 <?php //echo $fgroup;?> </small> </p> </div>
               
                  <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                    <div class="d-flex align-items-left"> 
					<i class="mdi mdi-calendar text-muted me-1"></i>
                      <p class="mb-0 text-small text-muted"> <?=$fgroup1." ( ".$total1." ) " ?> </p>
                    </div>  <?php }	?>
