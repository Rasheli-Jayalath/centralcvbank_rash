  ...
  <div class="content-wrapper">
    ...
    <form name="frmpersonalInfo" id="frmcontact" action=""  method="post" onsubmit="return personalinfo(this);"   enctype="multipart/form-data">
     ...
     <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
              <h2  >Notable Achievements/Publications:</h2>
             <font color="#FF0000"> <br />
						  <strong> [ Ctrl+Shift+V ]</strong> for Paste Data here.) </font>
                   <div class="table-responsive">
                     <tr>
                    <td height="86"> 
                    <textarea class="ckeditor" cols="100" id="editor1" rows="10" tabindex="1"  name="txtDescription" ><?= $txtDescription !="" ? $txtDescription : $db_aDesc ?></textarea>
		 ...
		 <div   align="center">
                ...
                if ( $edit != "" ) {
                  ?>
                <input type="submit" value="Update" name="update" class="btn btn-primary me-3" style="color: white;" onclick="return Achievements2(this);" />
                <?php
                } else {
                  ?>
                <input type="submit" value="Save" name="save" class="btn btn-primary me-3" style="color: white;" onclick="return Achievements2(this);" />
                <?
                }
                ?>
                &nbsp;&nbsp;
         ...
         <div class="col-lg-10 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                  Achievements/Publications  Detail
                  <h4>
                ...
                <tr>
                    ...
                    <th width="68%"> Achievement Detail</th>
                  ...
                  <?php
				   ...
				   <tr>
                       ...
                       <a href="achievements.php?id=<?=$cvID?>&edit=<?=$aId?>" title="Edit" ><img src="images/edit-icon.png" width="30" height="30" /></a>
                       </td>
                        <td style="border-bottom:1px solid #cccccc" width="14%" align="center">&nbsp; <a href="delete-achieve.php?id=<?=$cvID?>&delete=<?=$aId?>" onClick="javascript: confirm('Do you really want to delete this record?');" title="Delete record"><img src="images/deletebutton.png" alt="Delete" width="20" height="20"  /></a>
 	             </tr>
				   <?
					}
				}
