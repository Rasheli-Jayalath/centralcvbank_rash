          ...
          <div class="tab-content tab-content-basic">
            <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview">
              ...
              <form name="frmpersonalInfo" id="frmcontact" action=""  method="post" onsubmit="return personalinfo(this);"   enctype="multipart/form-data">
                ...
                <div class="card">
                <div class="card-body">
                <h3 class="card-title">Member of Professional Associations:</h3>
                <p class="card-description"> Please provide the Professional Membership Detail here:
                  Id: 
                  <?=$cvId;?>
                </p>
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <!--  <label class="col-sm-7 col-form-label">Enter Member of Professional Association(s)</label> -->
                      <div class="col-sm-9">
                        <input type="text" value="<?= $dsociety !="" ? $dsociety : $txtsociety ?>" name="txtsociety"  
 ...
 <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <tr>
                  ...
                  <th width="63%">Professional Associate(s)</th>
                  <th width="12%" align="center"> Edit  </th>
...
<!--					<td width="55%" height="27" style="border-bottom:1px solid #cccccc" >&nbsp;<?=  $mop?></td> -->
					...
					<td style="border-bottom:1px solid #cccccc" width="77%" height="50px" >&nbsp;<?=$society?></td>
					<td style="border-bottom:1px solid #cccccc" width="7%" align="center"><a href="mop.php?id=<?=$cvID?>&edit=<?=$mId?>"><img src="images/edit-icon.png" width="28" height="28" /></a>
					<td style="border-bottom:1px solid #cccccc" width="11%" align="center">&nbsp; <a href="delete-mop.php?id=<?=$cvID?>&delete=<?=$mId?>" onClick="javascript: confirm('Do you really want to delete this record?');" title="Delete Membership"><img src="images/deletebutton.png" alt="Delete" width="20" height="20" ></a>
