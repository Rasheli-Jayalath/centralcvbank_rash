...
<th width="3%" class="tablerw"> Level </th> 
<th width="3%" class="tablerw"> F.Group-1 </th> 

<!--<th width="3%" class="tablerw"> F.Group-2 </th> 

<th width="3%" class="tablerw"> Original CV</th>
<th width="3%" class="tablerw"> Edit</th>
<th width="3%" class="tablerw" valign="middle"> Verification <br> Status </th> 
<th width="8%" class="tablerw"  valign="middle"> Class </th>
<th width="6%" class="tablerw"  valign="middle"> Entered by</th>-->
...
-->
<td   class="cvclass"  style="border-bottom:1px solid #cccccc " align="center"  title="A: Most Usable,
B: Less Usable
C: General
D: Balcklisted
E: Inactive/No use"> 
...
<td width="3%" align="center" style="border-bottom:1px solid #cccccc">
    ...
    <script type="text/javascript">function confirm_delete(question) {if(confirm(question)){alert("CV has been Deleted!");}else{return false;} } 
	</script>
