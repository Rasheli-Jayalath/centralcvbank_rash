...
<div class="main-panel">
 ...
 <div class="col-lg-10 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Education Detail<h4>
                ...
                <tr>
                  <th width="8%">From</th>
                  <th width="8%">To</th>
                  <th width="13%">Employer</th>
                  <th width="13%">Position Held</th>
                  <th width="19%">Summary/ Description</th>
                  <th width="11%">Country</th>
                  <th width="11%">Ref. Name</th>
         ...
         <?
			...
			?>
             ...
             <td style="border-bottom:1px solid #cccccc" width="8%" align="center">&nbsp;
  <a href="firminfo.php?id=<?=$cvID?>&edit=<?=$fId?>"><img src="images/edit-icon.png" width="22" height="22" /></a></td>
          <td style="border-bottom:1px solid #cccccc" width="9%" align="center">&nbsp; <a href="delete-firminfo.php?id=<?=$cvID?>&delete=<?=$fId?>" onClick="javascript: confirm('Do you really want to delete this record?');" title="Delete Firm Info record"><img src="images/deletebutton.png" alt="Delete" width="20" height="20"  /></a>
 			</tr>
				   <?
					}
				}
