                            ...
                            <div class="card card-rounded" style="background-image: linear-gradient(to bottom right, #e2ebf0 , #e2ebf0 );">
                              <div class="card-body">
                                ...
                                <div class="row" style="text-align: center;">
                                      <div class="col">
                                      <button type="button" class="btn btn-lg btn-outline-primary position-relative" style="width: 300px;border:2px solid; border-color: #1976d2;">
                                                Agriculture
                                      ...
                                      <button type="button" class="btn btn-lg btn-outline-primary position-relative" style="width: 300px;border:2px solid; border-color: #1976d2;">
                                                Hydropower / Dam
                                                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">
                                                    59+
                                                      <span class="visually-hidden">Hydropower / Dam</span>
                                                    </span>
                                                  </button>
                                      </div>
                                </div>
                                ...
                                <div class="row" style=" text-align: center;margin-top: 10px;">
                                      ...
                                      <button type="button" class="btn btn-lg btn-outline-primary position-relative" style="width: 300px;border:2px solid; border-color: #1976d2;">
                                        Agriculture
                                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">
                                            84+
                                              <span class="visually-hidden">Infrastructure</span>
                                            </span>
                                          </button>
                                      </div>
                                </div>
                       ...
                       <!-- Chart CV Entry Progress -->
                        ...
                        <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                              <h4 class="card-title">CV Entry Progress</h4>
                              <canvas id="polarcventryprogress"></canvas>
                              </div>
                            </div>
                          </div>
                        </div>
                        <!-- Chart CV Entry Progress -->
                         ...
                         <!-- Chart Last Four Week -->
                         <div class="row flex-grow">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                              <h4 class="card-title">Last 4 Week CV Entry Progress</h4>
                              <canvas id="lastfourweek"></canvas>
                              </div>
                            </div>
                          </div>
                        </div>
