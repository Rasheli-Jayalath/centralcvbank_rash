                        ...
                        <div class="card-body">
                          ...
                          <!--	   <td class="label">Project Length Kms</td>
                                ...
                                <tr >
                                  <td>&nbsp;</td>
                                  <td colspan="3">
                                    <input style="margin-top: 15px;" class="btn btn-primary" type="submit" value="GO" name="btn"    onclick="return validateSearch();"  /></td>
                                </tr>
                                <tr>
